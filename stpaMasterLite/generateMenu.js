function onOpen(e) {
  ...
  ui.createMenu("STPAmaster")
    ...
    .addSubMenu(ui.createMenu("4. Loss scenarios")
      ...
      .addItem("Export scenarios", "exportLossScenariosToTsv")
      .addItem("Export to .ttl", "exportAllMetadataToLossScenariosTtl")
      .addItem("Export FLAT to .ttl", "exportAllMetadataToLossScenariosTtlFlat")
    )
